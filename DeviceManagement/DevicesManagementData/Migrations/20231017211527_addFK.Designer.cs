...
namespace DevicesManagementData.Migrations
{
    ...
    [Migration("20231017211527_addFK")]
    partial class addFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevicesManagementDomain.Device", b =>
                {
                    ...
                    b.Property<Guid?>("UserDeviceDeviceId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserDeviceUserId", "UserDeviceDeviceId");
            ...
            modelBuilder.Entity("DevicesManagementDomain.Device", b =>
                {
                    ...
                    b.HasOne("DevicesManagementDomain.UserDevice", null)
                        .WithMany("devices")
                        .HasForeignKey("UserDeviceUserId", "UserDeviceDeviceId");
